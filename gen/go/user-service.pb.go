...
var file_user_service_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x15, 0x2e, 0x75,
	...
	0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x06, 0x55,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x06, 0x44, 0x65,
...
var file_user_service_proto_depIdxs = []int32{
	0, // 0: users.User.Create:input_type -> users.CreateUserRequest
	2, // 1: users.User.Get:input_type -> users.GetUserRequest
	4, // 2: users.User.Update:input_type -> users.UpdateUserRequest
	6, // 3: users.User.Delete:input_type -> users.DeleteUserRequest
	1, // 4: users.User.Create:output_type -> users.CreateUserResponse
	3, // 5: users.User.Get:output_type -> users.GetUserResponse
	5, // 6: users.User.Update:output_type -> users.UpdateUserResponse
	7, // 7: users.User.Delete:output_type -> users.DeleteUserResponse
